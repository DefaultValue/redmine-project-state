class StateIssueQuery < Query
  ...
  self.available_columns = [
      ...
      QueryColumn.new(:tracker, :groupable => true),
      QueryColumn.new(:parent, :default_order => 'desc', :caption => :field_parent_issue),
      QueryColumn.new(:status, :groupable => true),
      QueryColumn.new(:priority, :default_order => 'desc', :groupable => true),
      QueryColumn.new(:subject),
      QueryColumn.new(:author, :groupable => true),
      QueryColumn.new(:assigned_to, :groupable => true),
      # QueryColumn.new(:fixed_version, :groupable => true),
      QueryColumn.new(:estimated_hours, :totalable => true),
      QueryColumn.new(:total_estimated_hours, :default_order => 'desc'),
  ...
  def available_columns
    ...
    if User.current.allowed_to?(:set_issues_private, nil, :global => true) ||
        User.current.allowed_to?(:set_own_issues_private, nil, :global => true)
      @available_columns << QueryColumn.new(:is_private, :groupable => true)
    end
